...
public class DNAString {
	...
	public int[] solution(String S, int[] P, int[] Q) {
		...
		CharSequence[] nuc = new CharSequence[] { "A", "C", "G", "T" };
		int index = 0;
		S = S.toUpperCase();
		
		if (S.length() > 0 && P.length == Q.length) {
	...
	public static void main(String[] args) {
		...
		ArraysUtil.display(obj.solution("CAGCCTA", new int[] { 2, 5, 0 }, new int[] { 4, 5, 6 }));
	}
